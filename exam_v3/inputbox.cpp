...
Inputbox::Inputbox(Application* _parent, int _x, int _y, int _sx, int _sy, string _cur, string _s, vector<string> _v):
    Widget(_parent, _x, _y, _sx, _sy), cur(_cur), s(_s + cur), v(_v)
{
